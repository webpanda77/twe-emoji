    ...
    (function ($, win) {
        ...
        var string = [{
            ...
            "emojiList": [{
                ...
                "unicode": "👁️‍🗨️",
                "tags": ["eye", "speech bubble", "witness"]
            }, {
                "unicode": "🗨️",
                "tags": ["dialog", "speech"]
            }, {
            ...
            "emojiList": [{
                ...
                "unicode": "🙏",
                "tags": ["ask", "hand", "please", "pray", "thanks"],
                "skins": [{
                    "unicode": "🙏🏻"
                }, {
                    "unicode": "🙏🏼"
                ...
                "unicode": "🤵",
                "tags": ["groom", "person", "person in tux", "tuxedo"],
                "skins": [{
                    "unicode": "🤵🏻"
                }, {
                    "unicode": "🤵🏼"
                ...
                "unicode": "🤵‍♀️",
                "tags": ["tuxedo", "woman", "woman in tux"],
                "skins": [{
                    "unicode": "🤵🏻‍♀️"
                }, {
                    "unicode": "🤵🏼‍♀️"
            ...
            "emojiList": [{
                ...
                "unicode": "🥬",
                "tags": ["bok choy", "cabbage", "kale", "lettuce", "pak choi"]
            }, {
                "unicode": "🥦",
                "tags": ["wild cabbage"]
            }, {
                ...
                "unicode": "🏺",
                "tags": ["aquarius", "drink", "jar", "jug", "zodiac"]
            }]
        }, {
            "group": 5,
            "emojiList": [{
                ...
                "unicode": "🚃",
                "tags": ["car", "electric", "railway", "railway carriage", "train", "tram", "trolleybus"]
            }, {
                "unicode": "🚄",
            ...
            "emojiList": [{
                ...
                "unicode": "🎯",
                "tags": ["bullseye", "dart", "game", "hit", "target"]
            }, {
                "unicode": "🪀",
                "tags": ["fluctuate", "toy"]
            }, {
            ...
            "emojiList": [{
                ...
                "unicode": "🦺",
                "tags": ["emergency", "hi-vis", "hi-viz", "high-vis", "high-viz", "jacket", "safety", "vest"]
            }, {
                "unicode": "👔",
                "tags": ["clothing", "tie"]
            }, {
            ...
            "emojiList": [{
                ...
                "unicode": "🚹️",
                "tags": ["lavatory", "man", "restroom", "wc"]
            }, {
                "unicode": "🚺️",
                "tags": ["lavatory", "restroom", "wc", "woman"]
            }, {
                "unicode": "🚻",
                "tags": ["lavatory", "wc"]
            }, {
                ...
                "unicode": "⚧️",
                "tags": ["transgender symbol"]
            }, {
                "unicode": "✖️",
                "tags": ["cancel", "multiplication", "sign", "x", "×"]
            }, {
                "unicode": "➕",
                "tags": ["+", "math", "maths", "sign"]
            }, {
                "unicode": "➖",
                "tags": ["-", "math", "maths", "sign", "−"]
            }, {
                "unicode": "➗",
                "tags": ["division", "heavy division sign", "math", "maths", "÷"]
            }, {
                "unicode": "♾️",
            ...
            "emojiList": [{
                ...
                "unicode": "🏳️‍⚧️",
                "tags": ["flag", "light blue", "pink", "trans", "transgender", "white"]
            }, {
                "unicode": "🏴‍☠️",
        ...
        $.fn.lsxEmojiPicker = function (options) {
            ...
            var emojiFaceContainer = $('<div></div>')
                .addClass('lsx-emojipicker-emoji lsx-emoji-tab lsx-emoji-face');

            var emojiHandContainer = $('<div></div>')
                .addClass('lsx-emojipicker-emoji lsx-emoji-tab lsx-emoji-hand hidden');

            var emojiHairContainer = $('<div></div>')
                .addClass('lsx-emojipicker-emoji lsx-emoji-tab lsx-emoji-hair hidden');

            var emojiAnimalContainer = $('<div></div>')
                .addClass('lsx-emojipicker-emoji lsx-emoji-tab lsx-emoji-animal hidden');
            
            var emojiFoodContainer = $('<div></div>')
                .addClass('lsx-emojipicker-emoji lsx-emoji-tab lsx-emoji-food hidden');

            var emojiHouseContainer = $('<div></div>')
                .addClass('lsx-emojipicker-emoji lsx-emoji-tab lsx-emoji-house hidden');

            var emojiGiftContainer = $('<div></div>')
                .addClass('lsx-emojipicker-emoji lsx-emoji-tab lsx-emoji-gift hidden');

            var emojiMusicContainer = $('<div></div>')
                .addClass('lsx-emojipicker-emoji lsx-emoji-tab lsx-emoji-music hidden');
            ...
            var faceEmoji = $('<li></li>')
                .addClass('selected')
                .html(string[0].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiFaceContainer.removeClass('hidden');
                });

            var handEmoji = $('<li></li>')
                .html(string[1].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiHandContainer.removeClass('hidden');
                });

            var hairEmoji = $('<li></li>')
                .html(string[2].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiHairContainer.removeClass('hidden');
                });

            var animalEmoji = $('<li></li>')
                .html(string[3].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiAnimalContainer.removeClass('hidden');
                });

            var foodEmoji = $('<li></li>')
                .html(string[4].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiFoodContainer.removeClass('hidden');
                });

            var houseEmoji = $('<li></li>')
                .html(string[5].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiHouseContainer.removeClass('hidden');
                });

            var giftEmoji = $('<li></li>')
                .html(string[6].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiGiftContainer.removeClass('hidden');
                });

            var musicEmoji = $('<li></li>')
                .html(string[7].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiMusicContainer.removeClass('hidden');
                });
            
            var objectEmoji = $('<li></li>')
                .html(string[8].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
            ...
            var flagEmoji = $('<li></li>')
                .html(string[9].emojiList[1].unicode)
                .click(function(e){
                    e.preventDefault();
                    $('ul.lsx-emojipicker-tabs li').removeClass('selected');
                    $(this).addClass('selected');
                    $('.lsx-emoji-tab').addClass('hidden');
                    emojiFlagContainer.removeClass('hidden');
                });
    
            tabs.append(faceEmoji)
                .append(handEmoji)
                .append(hairEmoji)
                .append(animalEmoji)
                .append(foodEmoji)
            ...
            createEmojiTab(0, emojiFaceContainer, container);
            createEmojiTab(1, emojiHandContainer, container);
            createEmojiTab(2, emojiHairContainer, container);
            createEmojiTab(3, emojiAnimalContainer, container);
            createEmojiTab(4, emojiFoodContainer, container);
            createEmojiTab(5, emojiHouseContainer, container);
            createEmojiTab(6, emojiGiftContainer, container);
            createEmojiTab(7, emojiMusicContainer, container);
            createEmojiTab(8, emojiObjectContainer, container);
            ...
            wrapper.append(searchWrapper)
                   ...
                   .append(emojiFoodContainer)
                   .append(emojiHouseContainer)
            ...
            if(settings.twemoji){
                twemoji.parse(emojiFaceContainer[0], {size: 72});
                twemoji.parse(emojiHandContainer[0], {size: 72});
                twemoji.parse(emojiHairContainer[0], {size: 72});
                twemoji.parse(emojiAnimalContainer[0], {size: 72});
                twemoji.parse(emojiFoodContainer[0], {size: 72});
                twemoji.parse(emojiHouseContainer[0], {size: 72});
                twemoji.parse(emojiGiftContainer[0], {size: 72});
                twemoji.parse(emojiMusicContainer[0], {size: 72});
                twemoji.parse(emojiObjectContainer[0], {size: 72});
                twemoji.parse(emojiFlagContainer[0], {size: 72});
        ...
        function createEmojiTab(type, container, wrapper){
            for(var i = 0; i < string[type].emojiList.length; i++){
                ...
                var emoticon = $('<span></span>')
                    .data('value', selectedEmoji.unicode)
                    .attr('title', selectedEmoji.tags[1])
                    .html(selectedEmoji.unicode);
